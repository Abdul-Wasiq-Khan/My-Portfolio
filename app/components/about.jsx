...
export default function About() {
  return (
    <div className="text-white bg-neutral-800  mx-6 mt-8 rounded-lg min-h-screen" >
      <div className="headings" data-aos="fade-up dat">About Me</div>
      
      <div className="flex flex-col lg:flex-row gap-8 p-5 m-4 rounded-lg" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        ...
        <div className="flex-1 mt-2" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
